...
* Note that, the Source_Classification_Code and summarySCC_PM25 files should be extracted first, and placed at a data folder that is above the code directory. It also works by modifying the file path in the R scripts to run the code.
* To call the functions, remember to Source them in Rstudio first. Otherwise, it would be run by directly pasting the scripts to Rstudio command console.
...
on emissions of PM2.5. This database is known as the National Emissions Inventory (NEI). You can read more information about the NEI 
